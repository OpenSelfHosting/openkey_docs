...
**Settings → Autofill** کھولنے سے `openkey_native_host.exe` یہاں رجسٹر ہوتا ہے:
...
**Settings → Autofill** host manifests `~/.config/google-chrome/`، Chromium، Edge، اور `~/.mozilla/native-messaging-hosts/` میں لکھتا ہے۔
