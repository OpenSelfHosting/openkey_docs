...
### Password health отправляет мои пароли в интернет?

Локальные проверки слабых/повторных остаются на устройстве. Опциональный Have I Been Pwned использует только **SHA-1 prefix k-anonymity** — никогда полный пароль. См. [Безопасность](./security).
